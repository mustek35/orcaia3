...
class GestorAlertas:
    ...
    def procesar_detecciones(self, boxes, last_frame, log_callback, cam_data):
        ...
        if hay_bote: # Handles class 8 detections from non-"Embarcaciones" models
        ...
        if hay_embarcacion: # Handles detections from "Embarcaciones" model (classes remapped to 1)
